...
function About() {
    return( 
        ...
        Welcome to B-Sporthood.<br/>
          ...
          <br/>
          <p className="para">We believe that India has a huge potential to bring at least 4 Olympic medals from 
          ...
          <br/>
          <p className="para">We value the needs of our customers and we try our level best to provide 
          ...
          <br/>
          <p className="para">We try to get better each and every day considering what different customers need. 
          We do not neglect anything and make sure we deal with with every feedback given. </p>
          <br/>
          <p className="para">We hope you enjoy this as much as we enjoy offering this opportunity to you. 
